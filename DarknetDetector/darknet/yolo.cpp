...
//char *voc_names[] = {"bicycle", "bus", "car", "motorbike"};
...
//        printf("i=%d: loss=%f, avg_loss=%f, c_rate=%f, %lf seconds, %d images\n", i, loss, avg_loss, get_current_rate(net), sec(clock()-time), i*imgs);
...
//    list *plist = get_paths("data/voc/2012_test.txt");
//    char **paths = (char **)list_to_array(plist);
...
//    int j;
//    FILE **fps =(float*) calloc(classes, sizeof(FILE *));
//    for(j = 0; j < classes; ++j){
//        char buff[1024];
//        snprintf(buff, 1024, "%s%s.txt", base, voc_names[j]);
//        fps[j] = fopen(buff, "w");
//    }
//    box *boxes =(float*) calloc(side*side*l.n, sizeof(box));
...
//    int nthreads = 2;
//    image *val =(float*) calloc(nthreads, sizeof(image));
//    image *val_resized =(float*) calloc(nthreads, sizeof(image));
//    image *buf =(float*) calloc(nthreads, sizeof(image));
//    image *buf_resized =(float*) calloc(nthreads, sizeof(image));
//    pthread_t *thr =(float*) calloc(nthreads, sizeof(pthread_t));
...
//    float thresh = .001;
//    float iou_thresh = .5; которая дефолтная
//    float nms = 0;
...
//        for(k = 0; k < sid которая дефолтная e*side*l.n; ++k){
//            if(probs[k][0] > thresh){
//                ++proposals;
//            }
//        }
...
//    int j;
//    float nms=.5;
//    box *boxes =(float*) calloc(l.side*l.side*l.n, sizeof(box));
